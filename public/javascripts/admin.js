	...
	index: {
		...
		selectSubMenu: function(n, jump) {
			...
			with (admin.index) {
				...
				if (jump) {
//					console.log($selectedSubMenu.attr('href'));
...
//						console.log($menus.index(e.target));
...
function compareVersion(ver1, ver2) {
	...
	var maxLen = arr1.length == arr2.length ? arr1.length: max(arr1.length, arr2.length);
